...
{d_misc_hash set [_x, []]} forEach ["PRIVATE_RIFLES","CORPORAL_RIFLES","SERGEANT_RIFLES","LIEUTENANT_RIFLES","CAPTAIN_RIFLES","MAJOR_RIFLES","COLONEL_RIFLES",
	...
	"PRIVATE_BACKPACK","CORPORAL_BACKPACK","SERGEANT_BACKPACK","LIEUTENANT_BACKPACK","CAPTAIN_BACKPACK","MAJOR_BACKPACK","COLONEL_BACKPACK",
	"PRIVATE_MINES","CORPORAL_MINES","SERGEANT_MINES","LIEUTENANT_MINES","CAPTAIN_MINES","MAJOR_MINES","COLONEL_MINES",
	"PRIVATE_MAGAZINES","CORPORAL_MAGAZINES","SERGEANT_MAGAZINES","LIEUTENANT_MAGAZINES","CAPTAIN_MAGAZINES","MAJOR_MAGAZINES","COLONEL_MAGAZINES",
	"PRIVATE_GOGGLES","CORPORAL_GOGGLES","SERGEANT_GOGGLES","LIEUTENANT_GOGGLES","CAPTAIN_GOGGLES","MAJOR_GOGGLES","COLONEL_GOGGLES",
	"PRIVATE_CARGOTHROW","CORPORAL_CARGOTHROW","SERGEANT_CARGOTHROW","LIEUTENANT_CARGOTHROW","CAPTAIN_CARGOTHROW","MAJOR_CARGOTHROW","COLONEL_CARGOTHROW"
];
