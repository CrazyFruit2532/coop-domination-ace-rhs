...
if (d_jumpflag_vec isEqualTo "") then {
	_flag setVariable ["d_jf_id", _flag addAction [format ["<t color='#4169E1' size='1.2'>%1</t>", localize "STR_DOM_MISSIONSTRING_296"], {_this spawn d_fnc_paraj}, 1, 1.5, true, true, "", "true", 10]];
} else {
